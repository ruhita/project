...
public class Menus {
	...
	public void introScreen() {
		System.out.println();
		System.out.println("================================================");
		System.out.println("!      DEVELOPED BY RUHITA RAVINDRA PATIL      !");
		System.out.println("!----------------------------------------------!");
	...
	public void mainMenuOptions() {
	    ...
	    System.out.println("|   2 - Display all operations      |");
	...
	public void mainMenu() {
		...
		do {
			...
			case 1:
					System.out.println();
					try {
						display.listAllFiles(Main.path);
	...
	public void subMenu() {
		...
		do {
			...
			case 1: 
					...
					fileName = file.trim();
					try {
						display.createNewFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 2: 
					...
					fileName = file.trim();
					try {
						display.deleteFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 3: 
					...
					fileName = file.trim();
					try {
						display.searchFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IllegalArgumentException e) {
						System.out.println(e.getMessage());
